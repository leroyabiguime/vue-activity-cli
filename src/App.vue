   ...
   <div id="app">
            ...
            <div class="columns">
                <div class="column is-3">
                  <activityCreate @activityCreate="addActivity" :categories="categories"/>
                </div>   
                ...
                <div class="box content" :class="{fetching: isFetching, 'has-error' : error}">
                  ...
                  <div v-if="!isFetching">
                    <div class="activity-length">Currentlty {{ activityLength }} activities</div>
  ...
  data () {
    ...
    computed: {
        ...
        activityMotivation() {
          ...
          {
            return 'Som man activities! Good Jobs'
          }
          else {
